...
| Axis | Values | Meaning |
|------|--------|---------|
| dataset | `ml`, `myket`, `kuairec`, `kuairand`, `anime` | BPR embedding catalogs (the default five; msd and lastfm are opt-in, see the README's runtime table) |
